...
@section('title', 'Add Tiffin Service')
        ...
        <div class="col-md-8 mx-auto">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <h1 class="h3 mb-0">Add Tiffin Service</h1>
                </div>
                <div class="card-body">
                    <form action="{{ route('tiffin.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('meal_type') is-invalid @enderror" id="meal_type" name="meal_type" required>
                                    ...
                                    <option value="combo" {{ old('meal_type') == 'combo' ? 'selected' : '' }}>Combo Meal</option>
                                </select>
                                @error('meal_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('cuisine') is-invalid @enderror" id="cuisine" name="cuisine" required>
                                    ...
                                    <option value="indian" {{ old('cuisine') == 'indian' ? 'selected' : '' }}>Indian</option>
                                    <option value="chinese" {{ old('cuisine') == 'chinese' ? 'selected' : '' }}>Chinese</option>
                                    <option value="italian" {{ old('cuisine') == 'italian' ? 'selected' : '' }}>Italian</option>
                                    <option value="thai" {{ old('cuisine') == 'thai' ? 'selected' : '' }}>Thai</option>
                                    <option value="mexican" {{ old('cuisine') == 'mexican' ? 'selected' : '' }}>Mexican</option>
                                    <option value="continental" {{ old('cuisine') == 'continental' ? 'selected' : '' }}>Continental</option>
                                    <option value="mixed" {{ old('cuisine') == 'mixed' ? 'selected' : '' }}>Mixed</option>
                                </select>
                                @error('cuisine')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div id="menu-items-container">
                                    @if(old('menu_items') && is_array(old('menu_items')))
                                        @foreach(old('menu_items') as $index => $item)
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <a href="{{ route('tiffin.index') }}" class="btn btn-outline-secondary ms-2">
